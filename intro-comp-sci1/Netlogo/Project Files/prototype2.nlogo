...
turtles-own [health opposite-color]
...
After clicking the setup button, you may place troops. Red units may only be placed on the left and blue units can only be placed on the right.
