...
breed [walls wall]
turtles-own [health   original-speed   speed   opposite-color   hit-chance]
...
to go
  ...
  ask walls [die?]
  ask turtles with [not (breed = bullets) and not (breed = walls)] [
...
to formationspawn [col hp bred spd orgspd hed]
  sprout 1 [
    set color col
    set health hp
    set breed bred
    set speed spd
    set original-speed orgspd
    set heading hed
  ]
end
...
to place-troop-formation-red
  ...
  ask n-of 100 patches with [pxcor < 0][
      formationspawn (red) (25) (kamikazis) (0.2) (0.2) (90)
    ]
  ]
  if troop-formation = "british army" [
    ask patches with [pxcor < 0 and remainder pxcor 10 = 0][
      formationspawn (red) (75) (muskets) (0.2) (0.2) (90)
    ]
  ]
end
...
to place-troop-formation-blue
  if troop-formation = "total mayhem" [
  ask n-of 100 patches with [pxcor > 0][
      formationspawn (blue) (25) (kamikazis) (0.2) (0.2) (270)
    ]
  ]
  if troop-formation = "british army" [
    ask patches with [pxcor > 0 and remainder pxcor 10 = 0][
      formationspawn (blue) (75) (muskets) (0.2) (0.2) (270)
    ]
  ]
...
troop-formation
troop-formation
"basic" "british army" "total mayhem"
1
